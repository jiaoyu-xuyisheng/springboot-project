package com.jiaoyu.rabbit.config;
...
public class RabbitConfig {
     ...
     */
    @Bean
    public Queue topicQueue1() { return new Queue(TOPIC_QUEUE1); }
    @Bean
    ...
    @Bean
    public Binding topicBinding2() {return BindingBuilder.bind(topicQueue2()).to(topicExchange()).with("lzc.#");}
     ...
     */
    @Bean
    public Queue fanoutQueue1() { return new Queue(FANOUT_QUEUE1); }
     ...
     */
    @Bean
    public Queue directQueue1() { return new Queue(DIRECT_QUEUE1); }
